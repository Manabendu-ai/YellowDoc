...
private val LedgerMindColors = darkColorScheme(
    primary = MintPrimary,
    onPrimary = OnMint,
...
private val LedgerMindShapes = Shapes(
 ...
 */
@Composable
fun LedgerMindTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = LedgerMindColors,
        typography = AppTypography,
        shapes = LedgerMindShapes,
        content = content,
    )
}
