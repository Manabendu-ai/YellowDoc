package com.ledgermind.app.ui.settings
...
import com.ledgermind.app.core.AppConfig
import com.ledgermind.app.ui.components.PrimaryButton
...
fun ServerSettingsSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = "Point the app at your LedgerMind FastAPI server. On a physical device, use your computer's LAN IP.",
