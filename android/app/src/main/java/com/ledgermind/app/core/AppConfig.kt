...
private val Context.settingsDataStore by preferencesDataStore(name = "ledgermind_settings")

/**
 * Holds the app-wide configuration, most importantly the base URL of the
 * LedgerMind FastAPI server. The value is persisted in DataStore so the
