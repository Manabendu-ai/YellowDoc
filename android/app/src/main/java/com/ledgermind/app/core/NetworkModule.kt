...
import com.ledgermind.app.data.api.LedgerMindApi
...
object NetworkModule {
    ...
    @Volatile
    private var cachedApi: LedgerMindApi? = null
    ...
    fun api(baseUrl: String): LedgerMindApi = synchronized(this) {
        ...
        retrofit.create(LedgerMindApi::class.java).also {
